...
class FRM_GENERATE_GROUP_LOAN_CONTRACT_EX(FRM_GENERATE_GROUP_LOAN_CONTRACT):
	ContractVB 			= 	HiddenField(requiredlabel("Village Bank/Centre", "*"),
	...
	def setVisible():
		...
		control_list = [("RepMode"),("TemplateBase"),("FwdBwdKey"),("BaseDateKey"),("PaymentHoliday"),("NumOfHolidayInstallment"),("WaiveInterest")]
