...
class FRM_GROUP_LOAN_CONTRACT_EX(FRM_GROUP_LOAN_CONTRACT):
	...
	SavingRate 			= 	TextField("Calculation Rate",
							default=0,
							description=u'1-%s' %"Borrower"
						)
	...
	def hotSelectField():
		...
		fielddisplay 	= "BorrowerTemplateBase"
		varname 		= "LoanProduct:$('#LoanProduct').val()"
		fun 			= ["BorrowerTemplateBase", varname, fielddisplay, "/Morakot/getTemplateBasefromProduct", "select2-open",]
		hotfield.append(fun)

		fielddisplay 	= "TemplateBase"
		varname 		= "LoanProduct:$('#LoanProduct').val()"
		fun 			= ["TemplateBase", varname, fielddisplay, "/Morakot/getTemplateBasefromProduct", "select2-open",]
		hotfield.append(fun)
	...
	def hotField():
		...
		fielddisplay 	+= "$('#TemplateBase').select2('data', {'id':data.TemplateBase,'text':data.TemplateBaseDes});"
		varname 		= "LoanProduct:$('#LoanProduct').val()"
		...
		fielddisplay 	= ("$('#Disbursed').val(data['results'].Amount)")
		fielddisplay 	+=(";$('#SavingRate').val(data['results'].SavingRate)")
		fielddisplay 	+=(";$('#LoanPurpose').select2('data',{'id':data['results']['DictPurpose']['id'],'text':data['results']['DictPurpose']['text']})")
		fielddisplay 	+=(";$('#CompulsorySaving').select2('data',{'id':data['results']['CompulsorySaving']['id'],'text':data['results']['CompulsorySaving']['text']})")
		fielddisplay 	+=(";$('#RateFixed').select2('data',{'id':data['results']['DictRateFixed']['id'],'text':data['results']['DictRateFixed']['text']})")
		varname 		= "BorrowerID:$('#BorrowerID').val(), Group:$('#Group').val(), ValueDate:$('#ValueDate').val()"
		fun 			= ["BorrowerID", varname, fielddisplay, "/Morakot/AutoCompleteGroupLoan", "change", "Disbursed"]
		hotfield.append(fun)
