...
@app.route("/Morakot/API/getTemplateBaseGenerateGroupLoan", methods=['GET'])
@checkLogOutSession
@checkLogOutTime
...
@app.route("/Morakot/API/getTemplateBase", methods=['GET'])
@checkLogOutSession
@checkLogOutTime
def getTemplateBase():
...
@app.route("/Morakot/API/LoanPurposeID", methods=['GET'])
@checkLogOutSession
@checkLogOutTime
...
@app.route("/Morakot/API/VBDescription", methods=['GET'])
@checkLogOutSession
@checkLogOutTime
def getVBDescription():
	...
	if VBObj:
		VBDescription = VBObj.Description
	return jsonify(VBDescription = VBDescription)

@app.route("/Morakot/SearchVB/", methods=['GET'])
@app.route("/Morakot/API/SearchVB/", methods=['GET'])
@checkLogOutSession
@checkLogOutTime
def routeSearchVB():
...
@app.route("/Morakot/API/Product/", methods=['GET'])
@checkLogOutSession
@checkLogOutTime
