...
def getMFI22(Branch = "ALL", ReportedDate = "", Period = 2, Month = "", Year = ""):
	...
	try:
		...
		CellSyle = {
					...
					'I8':'top*medium,FF000000',
					'K8':'top*medium,FF000000',
					'L8':'top*medium,FF000000',
					'M8':'top*medium,FF000000',
					'O8':'top*medium,FF000000',
					'P8':'top*medium,FF000000',
...
def getData(ID, Branch='HO', Period=6, ReportedDate="", GLTable='', GLObj='', Year='', Month='',ReportHeader=""):
	try:
		...
		ExcelRecord = {}
		ExcelRecord.update({				
			"H4" : ReportHeader.get('ReportedDate',""),
			"D5" : ReportHeader.get('CompanyName',""),
			"Q6" : Decimal(ReportHeader.get('ReportingRate',0))
		})
		...
		NBCBusinessLoan 		= (mktsetting.getAppSetting('NBCBusinessLoanN22')).split()
		NBCConsumerLoan 		= (mktsetting.getAppSetting('NBCConsumerLoanN22')).split()
		NBCOtherLoan 			= (mktsetting.getAppSetting('NBCOtherLoanN22')).split()
		NBCBusinessLoanSector 		= (mktsetting.getAppSetting('NBCBusinessLoanSectorN22')).split()
		NBCConsumerLoanSector 		= (mktsetting.getAppSetting('NBCConsumerLoanSectorN22')).split()
		NBCOtherLoanSector 			= (mktsetting.getAppSetting('NBCOtherLoanSectorN22')).split()
		...
		AVGIntRateOfUnsecuredLoanContract = getAVGIntRateOfLoanContract("ALL",LoanProduct=NBCConsumerLoan,LoanSector=NBCConsumerLoanSector)
		...
		AVGIntRateOfUnsecuredLoanContract = getAVGIntRateOfLoanContract("ALL",LoanProduct=NBCBusinessLoan,LoanSector=NBCBusinessLoanSector)
		...
		AVGIntRateOfUnsecuredLoanContract = getAVGIntRateOfLoanContract("ALL",LoanProduct=NBCOtherLoan,LoanSector=NBCOtherLoanSector)
		...
		TotalUnsOutUSDN5 				+= TotalSecOutUSDN5
...
def getAVGIntRateOfLoanContract(Branch = "ALL",**kwargs):
	...
	LoanObj = db.session.query(
								...
								case(
									[(
										and_(MKT_LOAN_CONTRACT.Currency == 'KHR', cast(MKT_LOAN_CONTRACT.Term,Float)/12 <= 1),
										(MKT_LOAN_CONTRACT.OutstandingAmount * cast(MKT_LOAN_CONTRACT.InterestRate, Float)) * cast(MKT_CURRENCY.OtherRate1, Float)/Monthly
									)],
								else_=0
								).label('IntKHRN1'),
								case(
