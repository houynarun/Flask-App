function getIcons(){
	var icons = `<input class="search-icon form-control" type="text" placeholder="search for icon" style="display:block;width: 100%;text-align:center;"><i class="fa fa-glass"></i>
