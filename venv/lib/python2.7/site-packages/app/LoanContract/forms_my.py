...
class FRM_LOAN_CONTRACT_MY(FRM_LOAN_CONTRACT):
	LoanStatus 		= 	SelectField(requiredlabel("Loan Status","*"),
							choices=[('SMT', 'Submitted'), ('APV', 'Approved'), ('DSB', 'Disbursed'), ('TPU', 'Topped-up'), ('DDT', 'Deducted'), 
									('TMN', 'Paid-off'), ('WOF', 'Written-off'), ('MRT', 'Matured')],
							coerce=str,
							default='SMT',
	...
	CoBorrowerID 	  =   RemoteTextField(getLanguage("Co-Borrower"), description="5-Co-Borrower")
	...
	@staticmethod
	def setWidth():
		base 			= super(FRM_LOAN_CONTRACT_MY, FRM_LOAN_CONTRACT_MY).setWidth()

		ListField = [('DisbursementDate', len3)]
	...
	@staticmethod
	def hotField():
		base 			= super(FRM_LOAN_CONTRACT_MY, FRM_LOAN_CONTRACT_MY).hotField()
		hotfield 		= []
	...
	@staticmethod
	def setVisible():
		base 			= super(FRM_LOAN_CONTRACT_MY, FRM_LOAN_CONTRACT_MY).setVisible()

		ListField = [("Collateral")]
		ListField.extend(base)
		return ListField
