...
class FRM_ACCOUNT_SVP(exform):
	...
	def listField():
		...
		AccProduct = MKT_ACC_PRODUCT.query.filter(MKT_ACC_PRODUCT.ID.in_(SavingPlan)).\
	...
	@staticmethod
	def setVisible():
		return [("AccCategory"),("JAccount"),
				("JoinID"),("FixedRate"),("Charge"),
				("Blocked"),("BlockReason")] #these fields are visible, but data still accessible 
