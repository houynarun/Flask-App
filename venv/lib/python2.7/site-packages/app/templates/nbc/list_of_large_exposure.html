...
<table class="table table-striped table-bordered" id="NBC004DBT">
	...
	<thead>
		<tr style="background:silver;">
			...
			<th rowspan="2" class="text-center">Number of loans</th>
			<th rowspan="2" class="text-center">Amounts in Riels (Millions)</th>
			<th rowspan="2" class="text-center">Other currencies translated into Riels</th>
			<th rowspan="2" class="text-center">Total in millions of Riels</th>
		</tr>
		<tr style="background:silver;">
