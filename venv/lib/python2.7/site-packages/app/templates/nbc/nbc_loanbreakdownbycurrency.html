	...
	<table class="table table-striped table-bordered" id="NBC004DBT">
		...
		<thead>
			...
			<tr style="background:{{ColumnHeader['background']}};color:{{ColumnHeader['color']}};">
				<th class="text-center">{{ getLang(Language, '110038') }}</th>
				<th class="text-center">{{ getLang(Language, '110039') }}</th>
				<th class="text-center">{{ getLang(Language, '110040') }}</th>
				<th class="text-center">AMOUNT OUTSTANDING (convert into Riels)</th>
				<th class="text-center">{{ getLang(Language, '110037') }}</th>
				<th class="text-center">{{ getLang(Language, '110041') }}</th>
			</tr>
		</thead>
		<tbody>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="N006L" method="GET">
