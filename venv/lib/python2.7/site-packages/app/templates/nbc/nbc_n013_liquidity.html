...
{% block content %}
    ...
    <div class="col-sm-12">
        ...
        <table id="mktlist" class="table table-striped table-bordered">
            ...
            <thead>
                <tr>
                    <th>PRUDENTIAL REQUIREMENT:</th>
                    <th>
                        LIQUID ASSETS
                        <hr>
                        ADJUSTED AMOUNT OF DEPOSITS
                    </th>
                    <th colspan="2">= OR> 100%</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {%for key, value in row.iteritems()%}
                        ...
                        {%if key != 'Type' %}
                            {% if i == 2 and len(row) == 4 %}
                                <td colspan="2">
                                    {{value}}
                                </td>
                            {% else %}
                                <td>
                                    {% if i == 0 %}{{ Space|safe }} {% endif %} {{value}}
                                </td>
                            {% endif %}
                        {%endif%}
                        {% set i = i + 1 %}
            ...
            {%endfor%}
                ...
                <tr>
                    ...
                    <td>
                        {{ mktmoney.formatNumber(float(Result['TotalLiquidAsset'])) }}
                        <hr>
                        {{ mktmoney.formatNumber(float(Result['VoluntarySaving'])) }}
                    </td>
                    <td>
                        {{ mktmoney.formatNumber(float(Result['DevidedResult'])) }} %
                    </td>
                </tr>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="/Morakot/Report/N013" method="GET">
