	...
	<table class="table table-striped table-bordered" id="NBC004DBT">
		...
		<thead>
			...
			<tr style="background:{{ColumnHeader['background']}};color:{{ColumnHeader['color']}};">
                ...
                <th class="text-center">BALANCE OUTSTANDING (CONVERT INTO RIELS)</th>
                <th class="text-center">INTEREST RATE PAID (INDICATE WHETHER PER MONTH, PER YEAR OR OTHERWISE)</th>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="N006D" method="GET">
