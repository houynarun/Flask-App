...
{% block content %}
        ...
        <div class="col-sm-12">
            <div style="margin-top: 8px;">
                ...
                <div class="col-sm-6" style="padding: 0;">
                    <a id="Verified" href="/Morakot/TrialBalance?Branch={{ Branch }}&Verified=Yes" class="btn btn-flat btn-labeled btn-warning pull-right" style="margin-left: 5px;">
    ...
    {% include 'msg_error.html' %}
     <div class="col-sm-12">
        ...
        <h4 class="header-4 text-center"><strong>As of: </strong> {{ str(AsOf).replace('00','12') }}</h4>
            ...
            <table id="mktlist" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-right" style="padding-right: 35px;">Movement Balance</th>
                                ...
                                <td class="text-right" style="padding-right: 35px;">
                                    ...
                                    {% if int(Period) == 1 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            {{ formatBalance(row.PrevMonthBal, BaseCurrencyObj,Rounding ) }}
                                            
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, row.PrevMonthBal, 0, 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                    ...
                                    {% elif int(Period) == 2 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            ...
                                            {{ formatBalance( setDecimal(row.PrevMonthBal) - setDecimal(row.CurrentPrevMonthBal) ,BaseCurrencyObj,Rounding ) }}

                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, setFloat(row.PrevMonthBal) - setFloat(row.CurrentPrevMonthBal), 0, 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                    ...
                                    {% elif int(Period) == 3 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            ...
                                            {{ formatBalance(setDecimal(row.PrevYearBal) - setDecimal(row.CurrentPrevYearBal), BaseCurrencyObj,Rounding) }}
                                            
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, setFloat(row.PrevYearBal)  - setFloat(row.CurrentPrevYearBal), 0, 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                    ...
                                    {% elif int(Period) == 4 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            ...
                                            {{ formatBalance(row.PrevYearBal, BaseCurrencyObj,Rounding) }}
                                            
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, setFloat(row.PrevYearBal), 0, 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                ...
                                <td class="text-right" style="padding-right: 35px;">
                                    ...
                                    {% if int(Period) == 1 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, row.PrevMonthBal, 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                    ...
                                    {% elif int(Period) == 2 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, setFloat(row.PrevMonthBal) - setFloat(row.CurrentPrevMonthBal), 0, 0, 0) }}
                                            {% endif %}
                                    ...
                                    {% elif int(Period) == 3 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, setFloat(row.PrevYearBal) - setFloat(row.CurrentPrevYearBal), 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                    ...
                                    {% elif int(Period) == 4 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, setFloat(row.PrevYearBal), 0, 0, 0) }}
                                            {% endif %}
                                        {% endif %}
                                ...
                                <td class="text-right" style="padding-right: 35px;">
                                    ...
                                    {% if int(Period) == 1 %}
                                        ...
                                        {% if row.CurrentMonthBal %}
                                            ...
                                            {{ formatBalance(row.CurrentMonthBal, BaseCurrencyObj,Rounding) }}
                                        ...
                                        {% else %}
                                            ...
                                            {{ formatBalance( 0, BaseCurrencyObj,Rounding) }}
                                    ...
                                    {% elif int(Period) == 2 %}
                                        ...
                                        {% if row.CurrentPrevMonthBal %}
                                            ...
                                            {{ formatBalance(row.CurrentPrevMonthBal, BaseCurrencyObj,Rounding) }}
                                    ...
                                    {% elif int(Period) == 3 %}
                                        ...
                                        {% if row.CurrentPrevYearBal %}
                                            ...
                                            {{ formatBalance(row.CurrentPrevYearBal, BaseCurrencyObj,Rounding) }}
                                    ...
                                    {% elif int(Period) == 4 %}
                                        ...
                                        {% if row.YTDBal %}
                                            ...
                                            {{ formatBalance(row.YTDBal, BaseCurrencyObj,Rounding) }}
                                ...
                                <td class="text-right" style="padding-right: 35px;">
                                    ...
                                    {% if int(Period) == 1 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            ...
                                            {{ formatBalance(row.Balance, BaseCurrencyObj,Rounding) }}
                                            
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, 0, row.Balance, 0, 0) }}
                                            {% endif %}
                                    ...
                                    {% elif int(Period) == 2 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, 0, row.PrevMonthBal, 0, 0) }}
                                            {% endif %}
                                    ...
                                    {% elif int(Period) == 3 %}
                                        ...
                                        {% if row.BalanceType == 'Dr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, 0, row.PrevYearBal, 0, 0) }}
                                            {% endif %}
                                ...
                                <td class="text-right" style="padding-right: 35px;">
                                    ...
                                    {% if int(Period) == 1 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, 0, 0, row.Balance, 0) }}
                                            {% endif %}
                                    ...
                                    {% elif int(Period) == 2 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, 0, 0, row.PrevMonthBal, 0) }}
                                            {% endif %}
                                    ...
                                    {% elif int(Period) == 3 %}
                                        ...
                                        {% if row.BalanceType == 'Cr' %}
                                            ...
                                            {% if not row.SubGL: %}
                                                {{ getConsolBal(TotalAmount, 0, 0, 0, row.PrevYearBal, 0) }}
                                            {% endif %}
