<div id="AdvanceContainer" 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-{{class}}">
            ...
            %}
            <select name="Month" id="Month" class="input-sm form-control" style="width: 100%;">
                <option value=""></option>
    ...
    <div {% if AuditedStatus == 'No' %} style="display:none;" {% endif %} class="form-group" id="AuditBox">
        <label for="Audit" class="col-sm-4 control-label">Audited:</label>
        <div class="col-sm-{{class}}">
             <select name="Audit" id="Audit" class="input-sm form-control" style="width: 100%;">
                {% if Audit == '1' %}
