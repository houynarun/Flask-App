...
{% for key,value in ChargeAmount.iteritems() %}
	...
	{% set Charge = value['ChargeAmount'] if isDisbAment==False else 0 %}
	{% set Promo  = value['PromotionAmount'] if isDisbAment==False else 0 %}
	<tr>
		<td>{{ Desc }}</td>
			...
			<div class="col-xs-12">
				<div class="panel colourable panel-info panel-dark" style="height: 350px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="input-sm form-control" type="number" value="{{Promotion if Promotion else 0}}" placeholder="" name="Promotion" id="Promotion" required="required" min="0" style="width:214px;">
								<script type="text/javascript">
						...
						<div class="form-group">
							<label class="col-sm-3">Other Fee <span style="color:#d38e99">*</span></label>
							<div class="col-sm-8">
								<input class="input-sm form-control" type="number" value="{{OtherFee if OtherFee else 0}}" placeholder="" name="OtherFee" id="OtherFee" required="required" min="0" style="width:214px;">
								<script type="text/javascript">
	...
	<!-- /Form Input ID -->
		<div id="Main">
			{% if LoanObj %}
				...
				{% set CurrSign = '$' if LoanObj.Currency=='USD' else '៛' %}
				...
				{% set TotalAmount = float(ApprovalAmount) - float(TotalCharge) - float(OtherFee) + float(TotalPromo) + float(Promotion) %}
				...
				{% if TotalAmount >= 0 %}
					...
					<div class="col-xs-12" style="padding:0px;">
						...
						<div class="col-xs-12">
									...
									<div class="row">
										<div class="col-xs-12">
											<p class="col-xs-4 col-xs-offset-8 text-bold" style="margin-left:67.666667%;">Transaction Date: {{ TranDate }}</p>
										</div><br><br>
										<div class="col-xs-12">
										<!-- Table Left -->
								...
								<div class="col-xs-12">
									...
									<tr>
										<td>Other Fee</td>
										<td>{{ CurrSign }} ({{ mktmoney.toMoney(float(OtherFee),CurrencyObj) }})</td>
									</tr>
									<tr>
