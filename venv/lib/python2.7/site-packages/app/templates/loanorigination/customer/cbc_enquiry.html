		...
		<div style="font-size: 13px;margin: 10px" class="alert alert-info">
			...
			<div style="display: inline;">
				...
				<form style="float: left;">
					<a class='btn btn-flat btn-success btn-xs' href="?Accept={{ Accept }}&ID={{ ID }}" onclick="fn_fadeIn();">Yes</a>
											...
											<tbody>
												...
												{% if ConsumerObj %}
													...
													<tr>
														...
														<td>{{ProvidedObj.PCNAM.PCNMFE}}</td>
														<td>{{AvailableObj.ACNAM.ACNMFE}}</td>
													</tr>
													<tr>
														<td><b>&ensp;&ensp;First Name</b></td>
														<td>{{ProvidedObj.PCNAM.PCNM1E}}</td>
														<td>{{AvailableObj.ACNAM.ACNM1E}}</td>
													</tr>
													<tr>
														<td><b>&ensp;&ensp;Second Name</b></td>
														<td></td>
