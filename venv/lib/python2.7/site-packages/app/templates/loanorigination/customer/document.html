...
{% block content %}
		...
		<form method="GET" id="frm" name="frm" role="form" action="/Morakot/Document/">
			<div class="col-sm-12">
				...
				{% if Add == 'Y' %}
					...
					<div class="col-sm-8" style="margin-top:16px; padding:0px">
				...
				{% else %}
					...
					<div class="col-sm-2" style="margin-top:8px; padding:0px;">
						...
						<div class="col-sm-4" style="margin-top:8px;">
							...
							{% else %}
								<a href="/Morakot/Document/?ID={{ ID }}&Trash=Y" class="btn btn-flat btn-labeled btn-primary pull-right" title="Restore from Trash">
					                <span class="icon fa fa-history"></span>&nbsp;&nbsp; History Files
					            </a>
				            {% endif %}
    ...
    <div class="col-sm-12" id="client-side-alert" style="display: none">
			...
			{% if Add == 'Y' %}
				...
				<form class="form-horizontal" action="/Morakot/Document/Upload/" method="POST" enctype="multipart/form-data" id="PostAttachment">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <label for="file" class="col-sm-2 control-label">Browse File ({{AllowExtension}} ) <span style="color:#d38e99">*</span></label>
	                        <div class="col-sm-10">
								...
								{% for item in DocumentObj %}
									...
									<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6">
										<div class="thumbnail" style="overflow: hidden;">
											...
											{% else %}
												<iframe class="embed-responsive-item" src="{{url_image}}?zoom=15&scrollbar=0&toolbar=0&navpanes=0" style="height: 196px;width: 100%;overflow: hidden;border: 0px">
										  		</iframe>
											{% endif %}	
