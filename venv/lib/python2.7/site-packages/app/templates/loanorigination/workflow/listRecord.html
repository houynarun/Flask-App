                        ...
                        {% if recordReview !=0 %}
                            ...
                            {% for lo in listRecordReviewObj %}
                                <tr class="link" onclick="CustomClickView('{{formTitle}}',
                                             'LO/ReviewApproveCustom?ID={{lo.RecordID}}&formID={{formID}}&InBranch={{lo.Branch}}')">
                                    <td>{{lo.Branch}}</td>
                                    <td>{{lo.RecordID}}</td>
                                    <td>{{lo.Inputter}}</td>
                                    <td>{{lo.Createdon}}</td>
                        ...
                        {% if recordApprove !=0 %}
                            ...
                            {% for lo in listRecordApproveObj%}
                                <tr onclick="CustomClickView('{{formTitle}}',
                                             'LO/ReviewApproveCustom?ID={{lo.RecordID}}&formID={{formID}}&InBranch={{lo.Branch}}')" class="link">
                                    <td>{{lo.Branch}}</td>
                                    <td>{{lo.RecordID}} </td>
                                    <td>{{lo.Inputter}}</td>
                                    <td>{{lo.Createdon}}</td>
