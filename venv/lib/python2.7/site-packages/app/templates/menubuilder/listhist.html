        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                {%- for row in menu %}
                    <tr>
                        <td>{{ row.ID }}</td>
                        <td><a href="/Morakot/MenuBuilder/{{ row.ID }}">{{ row.Description }}</a></td>
                        {% if not is_hist %}
                        <td>
                            <a href="/Morakot/MenuBuilder/Edit/{{ row.ID }}" class="link">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#New').click(function(e) {
                window.location = '/Morakot/MenuBuilder/New/'+$('#ID').val();
            });
            ...
            $("#ID").keyup(function(event){
                if(event.keyCode == 13){
                    window.location = '/Morakot/MenuBuilder/'+$('#ID').val();
                }
            });
