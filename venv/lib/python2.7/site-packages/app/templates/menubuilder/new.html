...
{% macro getForm(ID) %}
    ...
    {%for row in FormObj -%}
    <li data-ItemID="" data-formid="{{row.ID}}:{{row.FormID}}" data-formdesc="" data-act="{{row.Active}}" data-icon=""><i class="" ></i>{{row.FormDesc}}
                ...
                <div class="container">
                    ...
                    <div class="col-xs-6">
                        ...
                        <ol class="example forms" id="myUL" data-toggle="collapse">
                            {% for mod in Module -%}
                            <li data-ItemID="" data-module="" data-formdesc="" data-act="" data-icon=""><i class=""></i>{{mod.Description}}<a href="JavaScript:void(0)" style="visibility: hidden;"><i class="fa fa-pencil modal-trigger" data-toggle="modal" aria-hidden="true" data-target="#update-item"></i></a>
                    ...
                    <div class="col-xs-6">
                        <h4 class="center">Menu Previewl</h4>
    ...
    <script>
        $(document).ready(function(){
            '{% if unsortable == "unsortable" %}'
                ...
                $('#ID,input.new-parent').attr('readonly','readonly');
        ...
        $(document).ready(function() {
            ...
            $('#Save').click(function(e) {
                ...
                if(isValidMenuItem()==false){
                    ...
                    //     '<button type="button" class="close" data-dismiss="alert">&times;</button><b>Unable to Save!</b> Menu has too many nested level. Only 2 levels allowed.</div>');
                    return false;
                }
