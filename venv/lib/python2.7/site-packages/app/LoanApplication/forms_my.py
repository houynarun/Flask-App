...
class FRM_LOAN_APPLICATION_MY(FRM_LOAN_APPLICATION):
	...
	@staticmethod
	def setVisible():
		base 			= super(FRM_LOAN_APPLICATION_MY, FRM_LOAN_APPLICATION_MY).setVisible()

		ListField = [("Collateral"), ("CoBorrowerID"), ("RelationIndicator")]
		ListField.extend(base)
		return ListField

	@staticmethod
	def hotField():
		base 			= super(FRM_LOAN_APPLICATION_MY, FRM_LOAN_APPLICATION_MY).hotField()
		hotfield 		= []
